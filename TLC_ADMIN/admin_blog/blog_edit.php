...
<div class="container-fluid">
  <div class="row">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../admin_blog/blog.php">
             ...
             ADD BLOG<span class="sr-only">(current)</span>    / EDIT
            </a>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <?php
        $data = "SELECT * FROM blog WHERE id='$pid'";
            ...
            <div class="card-body">
                <form action="edit.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" id="bname" name="bname" value="<?php echo $row['bname']; ?>" placeholder="Blog name" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="aname" name="aname" value="<?php echo $row['aname']; ?>" placeholder="Author Name" required>
                    </div>
                    <div class="form-group">
                        <label for="aimage">Add Author image</label>
                        <input type="text" class="form-control" id="a_old_image" name="a_old_image" value="<?php echo $row['aimage']; ?>" placeholder="Author Name" readonly>
                        <input type="file" class="form-control" id="aimage" name="aimage" placeholder="Author Name" >
                    </div>
                    <div class="form-group">
                        <input type="date" id="date" name="date" class="form-control" value="<?php echo $row['date']; ?>" required>
                    </div>
                    <div class="form-group">
                        <input type="text" id="brief" name="brief" class="form-control" value="<?php echo $row['brief']; ?>" placeholder="Description" required>
                    </div>
                    <div class="form-group">
                      <label for="new_image" style="color: #ffffff !important;">Enter a display image!</label>
                      <input type="text" name="old_image" id="old_image" class="form-control input-lg" value="<?php echo $row['image']; ?>" readonly>
                      <input type="file" name="new_image" id="new_image" class="form-control input-lg" required>
                    </div>
                    <div class="form-group">
