...
<div class="container-fluid">
  <div class="row">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../admin_podcasts/index.php">
              <span data-feather="view blogs"></span>
            ADD PODCASTS / EDIT <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <?php
        $videos = "SELECT * FROM podcasts WHERE podcast_id='$pid'";
                ...
                <form action="edit.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="header" style="color: #ffffff !important;">header</label>
                        <input  type="text" id="header" name="header" value="<?php echo $row['header']; ?>" class="form-control" placeholder="Video Link" required>
                    </div>
                    <div class="form-group">
                      <label for="audio_link" style="color: #ffffff !important;">podcast link (optional)</label>
                        <input  type="text" id="audio_link" name="audio_link" value="<?php echo $row['audio_link']; ?>" class="form-control" placeholder="Video Link" required>
                    </div>
                    <div class="form-group">
                       <label for="podcast_pic" style="color: #ffffff !important;">Current pic</label>
                       <br>
                        <img src="podcast_images/<?php echo $row['pic']; ?>" alt="" width="200" height='200' id="thumbnail_image">
                        <br>
                        <label for="podcast_pic" style="color: #ffffff !important;">Enter new pic</label>
                        <input type="file" class="form-control" id="podcast_pic"  name="podcast_pic" placeholder="pic " required>
                        <input type="text" class="form-control" id="podcast_old_pic" value="<?php echo $row['pic']; ?>" name="podcast_old_pic" readonly required>
                    </div>
                    <div class="form-group">
                        
                         <label for="podcast_audio" style="color: #ffffff !important;">Update audio </label>
                      <input type="file" class="form-control input-lg" id="podcast_audio" name="podcast_audio">
                      <input type="text" class="form-control input-lg" id="podcast_old_audio" value="<?php echo $row['audio']; ?>" readonly name="podcast_old_audio">
                     
                    </div>
                    
                    <div class="form-group">
                      <label for="details" style="color: #ffffff !important;">audio details </label>
                        <textarea name="details" id="details" cols="30" rows="10" class="form-control"><?php echo $row['details']; ?></textarea>
                    </div>
